...
const std2 = { addr: "안산", phone: "010-0000-0000" };
const std3 = { ...std, ...std2 };
...
const [{ id: id1, text: text1 }, { id: id2, text: text2 }, { id: id3, text: text3 }] = arrobj;
